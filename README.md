<h1>ALTTPR Tracker (v1.1.0 release)</h1>
<p>
...
Special Thanks to  [Jedi Master T8ter](https://linktr.ee/jedi_master_t8ter) for showing this tracker on stream and testing it.  Another Special thanks to [LordHoell](https://linktr.ee/lordhoell) for indirectly providing ideas for the ItemTracker and for providing the idea on how to vibe code the map.
