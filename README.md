...
Special Thanks to  [Jedi Master T8ter](https://linktr.ee/jedi_master_t8ter) for showing this tracker on stream and testing it.  Another Special thanks to [LordHoell](https://linktr.ee/lordhoell) for indirectly providing ideas for the ItemTracker and for providing the idea on how to vibe code the map, [Max2dgam1ng](https://linktr.ee/max2dgam1ng) for getting me into this game, and [Limpbagel](https://linktr.ee/limpbagel) for tutorials to [Stonks tracker](https://thettracker.vercel.app/) for some of the elements used in the tracker, and finally the [ALTTPR community](https://alttpr.com) with an amazing [tracker](https://alttprtracker.mfns.dev/index.html).
